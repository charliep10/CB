--ROBERT TERRY
SELECT CAST (CASE WHEN [ORDER_COMPLETE_DTE] = '2019-04-27' THEN '2019-04-26'
		WHEN [ORDER_COMPLETE_DTE] = '2019-04-28' THEN '2019-04-26'
		WHEN [ORDER_COMPLETE_DTE] = '2019-05-04' THEN '2019-05-03'
		WHEN [ORDER_COMPLETE_DTE] = '2019-05-05' THEN '2019-05-03'
		WHEN [ORDER_COMPLETE_DTE] = '2019-05-11' THEN '2019-05-10'
		WHEN [ORDER_COMPLETE_DTE] = '2019-05-12' THEN '2019-05-10'
		WHEN [ORDER_COMPLETE_DTE] = '2019-05-18' THEN '2019-05-17'
		WHEN [ORDER_COMPLETE_DTE] = '2019-05-19' THEN '2019-05-17'
		ELSE ORDER_COMPLETE_DTE END AS DATE) AS ORDER_COMPLETE_DTE --UPDATE EVERY MONTH
	,[REGION]
	,[DATA_SOURCE]
	,[PROD_NAME]
	,CASE WHEN [PROD_NAME] = 'BUSINESS INTERNET' THEN 'Data'
			...
			WHEN [PROD_NAME] IN ('BUSINESS CLASS TELEWORKER STANDARD','BUSINESS CLASS TELEWORKER ENHANCED') THEN 'Teleworker'
			WHEN [PROD_NAME] IN ('SV WIFI PRO','LB WIFI PRO') THEN 'WiFi Pro'
			WHEN [PROD_NAME] IN ('SV CONNECTION PRO','CONNECTION PRO','CONNECTION PRO - SINGLEVIEW') THEN 'Connection Pro'
			ELSE 'Other' END AS 'PRODUCT'
	,[ORD_TYPE]
	,ABS([NET_QTY]) AS NET_QTY
	,CASE WHEN [PROD_NAME] = 'BUSINESS INTERNET' AND [ORD_TYPE] = 'CON' AND [DATA_SOURCE] ='NDW' THEN 'Total CxData'
			...
			WHEN [PROD_NAME] IN ('BUSINESS VIDEO PRIVATE') AND [ORD_TYPE] = 'CON' AND [DATA_SOURCE] IN ('NDW','UCBL') THEN 'Total CxVideo'
			WHEN [PROD_NAME] IN ('BUSINESS VIDEO PRIVATE') AND [ORD_TYPE] = 'VOL' AND [DATA_SOURCE] IN ('NDW','UCBL') THEN 'Total DxVideo'
			WHEN [PROD_NAME] IN ('BUSINESS VIDEO PRIVATE') AND [ORD_TYPE] = 'NOP' AND [DATA_SOURCE] = 'WODM' THEN 'Non-PayVideo'
			WHEN [PROD_NAME] IN ('BUSINESS VIDEO PUBLIC') AND [ORD_TYPE] = 'CON' AND [DATA_SOURCE] = 'UCBL' THEN 'Total CxVideo'
			WHEN [PROD_NAME] IN ('BUSINESS VIDEO PUBLIC') AND [ORD_TYPE] = 'VOL' AND [DATA_SOURCE] = 'UCBL' THEN 'Total DxVideo'
			WHEN [PROD_NAME] IN ('BUSINESS VIDEO PUBLIC') AND [ORD_TYPE] = 'NOP' AND [DATA_SOURCE] = 'WODM' THEN 'Non-PayVideo'
			...
			WHEN [PROD_NAME] IN ('BUSINESS CLASS TELEWORKER STANDARD','BUSINESS CLASS TELEWORKER ENHANCED') AND [ORD_TYPE] = 'CON' AND [DATA_SOURCE] = 'NDW' THEN 'Total CxTeleworker'
			...
			WHEN [PROD_NAME] IN ('SV CONNECTION PRO','CONNECTION PRO','CONNECTION PRO - SINGLEVIEW') AND [ORD_TYPE] = 'CON' AND [DATA_SOURCE] = 'NDW' THEN 'Total CxConnection Pro'
			WHEN [PROD_NAME] IN ('SV CONNECTION PRO','CONNECTION PRO','CONNECTION PRO - SINGLEVIEW') AND [ORD_TYPE] = 'VOL' AND [DATA_SOURCE] = 'NDW' THEN 'Total DxConnection Pro'
			WHEN [PROD_NAME] IN ('SV CONNECTION PRO','CONNECTION PRO','CONNECTION PRO - SINGLEVIEW') AND [ORD_TYPE] = 'NOP' AND [DATA_SOURCE] = 'WODM' THEN 'Non-PayConnection Pro'
...
FROM [RptFin].[ext].[v_ExcelSummaryDOR_Comp60]
  WHERE [ORDER_COMPLETE_DTE] BETWEEN '2019-04-22' AND '2019-05-21' --UPDATE EVERY MONTH
